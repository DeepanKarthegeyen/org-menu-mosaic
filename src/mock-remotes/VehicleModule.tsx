    ...
    <div className="p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Mock Vehicle Production Module</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              This is a mock implementation of the Vehicle Production module.
            </p>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-muted-foreground">
                This would normally be loaded from http://localhost:3003
              </p>
            </div>
          </div>
        </CardContent>
