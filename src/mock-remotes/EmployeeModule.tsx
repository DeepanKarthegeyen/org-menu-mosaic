    ...
    <div className="p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Mock Employee Management Module</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              This is a mock implementation of the Employee Management module.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border rounded-lg">
                <h3 className="font-semibold mb-2">Employee Count</h3>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-muted-foreground">
                This would normally be loaded from http://localhost:3001
              </p>
            </div>
          </div>
        </CardContent>
